...
module.exports = function ({ EgresoAgrofirmaController, checkMiddleware }) {
	const router = Router();
	...
	router.post(
		"/registrarEgreso", checkMiddleware.checkToken,
	...
	router.get(
		"/obtenerEgresos/:idProyecto", checkMiddleware.checkToken,
		EgresoAgrofirmaController.obtenerEgresos.bind(EgresoAgrofirmaController)
	);

	router.get(
		"/obtenerEgreso/:id", checkMiddleware.checkToken,
